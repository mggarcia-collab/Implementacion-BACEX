          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "10px", marginBottom: "10px" }}>
            ...
            {!eliminado && (
              <button
                ...
                style={{ padding: "6px 14px", fontSize: "12px", whiteSpace: "nowrap" }}
              >
                {eliminando ? "Eliminando..." : "Eliminar este Documento"}
              </button>
            )}
          </div>
          {eliminado && (
...
function TabProximamente({ titulo }) {
  return (
    <div style={{ background: "#f8f9fa", border: "1px dashed #dcdfe6", borderRadius: "8px", padding: "40px 20px", textAlign: "center", color: "#697386" }}>
      <div style={{ fontSize: "15px", fontWeight: "600", marginBottom: "6px" }}>{titulo}</div>
      <div style={{ fontSize: "13px" }}>Próximamente — esta sección se agregará en un siguiente paso.</div>
    </div>
  );
}
...
export default function CrearDocumentosPostFacturacion({ onNavigate }) {
  ...
  return (
    <div className="form-wrap" style={{ position: "relative", zIndex: 1, maxWidth: "900px" }}>
      ...
      {tab === "fiscal" && <TabProximamente titulo="Documentos Fiscales" />}
      {tab === "interno" && <TabProximamente titulo="Documentos Internos" />}
    </div>
  );
}
