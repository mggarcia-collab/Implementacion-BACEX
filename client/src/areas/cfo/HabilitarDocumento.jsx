...
export const meta = {
  ...
  icon: "✅",
  desc: "Buscar y habilitar documentos",
  kind: "primary",
};
...
export default function HabilitarDocumento() {
  ...
  // Refresca la tabla con el criterio actualmente filtrado, para que el Estado/Dueño que se
  // ve en pantalla siempre sea el real del servidor después de habilitar/deshabilitar (y no
  // una suposición local que puede quedar desactualizada si algo más modificó el documento).
  ...
  return (
    <div className="form-wrap" style={{ position: "relative", zIndex: 1, maxWidth: "100%" }}>
      ...
      {searched && documentos.length === 0 && (
        <p style={{ color: "#697386", fontSize: "14px" }}>No se encontraron documentos para esos criterios de búsqueda.</p>
      )}
